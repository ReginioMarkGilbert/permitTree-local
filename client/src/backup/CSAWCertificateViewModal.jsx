...
const CSAWCertificateViewModal = ({ isOpen, onClose, certificate }) => {
      ...
      try {
         ...
         if (contentType === 'application/pdf') {
            ...
            if (newWindow) {
               ...
               handleDownload(fileData, certificate.uploadedCertificate.filename, contentType);
            }
         }
         // For images
            ...
            if (newWindow) {
               newWindow.document.write(`
                  <html>
                     <head>
                        <title>${certificate.uploadedCertificate.filename}</title>
                        <style>
                           body {
                              margin: 0;
                              display: flex;
                     ...
                     <body>
                        <img src="${fileUrl}" alt="${certificate.uploadedCertificate.filename}" />
                     </body>
                  </html>
               `);
            } else {
