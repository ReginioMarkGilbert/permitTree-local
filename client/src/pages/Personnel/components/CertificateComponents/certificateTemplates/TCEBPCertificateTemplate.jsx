...
const TCEBPCertificateTemplate = forwardRef(({ certificate, application, orderOfPayment, hiddenOnPrint = [] }, ref) => {
   const certificateData = {
      ...application,
      name: application?.ownerName || application?.name,
      requestType: application?.otherDetails?.requestType,
      purpose: application?.purpose || application?.otherDetails?.purpose,
      contactNumber: application?.otherDetails?.contactNumber
   };

   console.log('TCEBP Template Data:', {
      certificateData,
      certificate,
      orderOfPayment
   });
   ...
   const qrValue = JSON.stringify({
      ...
      requestType: certificateData?.requestType,
      ...
      <div ref={ref} className="p-8 bg-white">
         <div className="text-center mb-8">
            <div className="flex justify-center items-center gap-4 mb-4">
               ...
               <div>
                  <h1 className="text-xl font-bold">TREE CUTTING AND/OR EARTH BALLING PERMIT</h1>
         ...
         <div className="mb-6">
            <p className="mb-2">Permit Details:</p>
            <div className="grid grid-cols-2 gap-4">
               <div>
                  <p><span className="font-bold">Request Type:</span> {certificateData?.requestType}</p>
...
TCEBPCertificateTemplate.displayName = 'TCEBPCertificateTemplate';

export default TCEBPCertificateTemplate;
