...
const TechnicalStaffApplicationFilters = ({ filters, setFilters }) => {
   ...
   // Select Component based on browser
   ...
   // Date Range Component based on browser
...
export default TechnicalStaffApplicationFilters;
