                           ...
                           <div>
                              ...
                              <div className="mt-2 space-y-2">
                                 <div className="flex items-center space-x-2">
                                    ...
                                    />
                                    <Label htmlFor="withinPrivateLand" className="text-sm font-medium text-foreground">Within Private Land</Label>
                                 </div>
                                 <div className="flex items-center space-x-2">
                                    <Checkbox
                                    ...
                                    />
                                    <Label htmlFor="withinTenuredForestLand" className="text-sm font-medium text-foreground">Within Tenured Forest Land</Label>
                                 </div>
                              </div>
                           </div>
