...
const ViewPaymentProofModal = ({ isOpen, onClose, paymentProof }) => {
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
         <DialogContent className="max-w-md">
            <DialogHeader>
               ...
               <DialogDescription>View the details of the payment proof.</DialogDescription>
            </DialogHeader>
