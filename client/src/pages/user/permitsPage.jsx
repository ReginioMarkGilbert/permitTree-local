        ...
        <div className="bg-green-50 min-h-screen flex flex-col">
            <header className="bg-green-800 text-white p-4">
                <div className="container mx-auto flex justify-between items-center">
                    <h1 className="text-2xl font-bold">DENR PENRO Permit Issuance</h1>
                    <button className="text-white border-white hover:bg-green-700">Sign In</button>
                </div>
            </header>
                    ...
                    {permits.map((permit, index) => (
                        <div key={index} className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 rounded-lg min-h-[200px] w-full">
                            <div className="flex items-center text-green-800 mb-4">
                                <span className="ml-2">{permit.title}</span>
                            </div>
