   ...
   return (
      <div className="bg-white p-3 rounded-lg shadow-sm">
         ...
         <input
            ...
            onChange={onChange}
            readOnly={readOnly}
            className={`mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm ${readOnly ? 'bg-gray-100' : ''
               }`}
         />
      </div>
   );
